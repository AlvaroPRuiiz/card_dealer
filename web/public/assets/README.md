# Assets públicos de ELCO-DEALER

La web referencia estos archivos:

- `logo_elco_dealer.svg`: fuente vectorial oficial del logo de la web.
- `logo_elco_dealer_primary.png`: PNG principal usado en navbar, footer y favicon.
- `logo_elco_dealer.png`: logo de documentación/respaldo legacy, conservado porque se usa también en los documentos.
